...
<h2 style="padding-bottom: 2rem;padding-top: 2rem;text-align: center">Grade B Players</h2>
  ...
  <thead>
   ...
   // $sql="SELECT pname,team,date_of_birth,age,coach_name from `testing_val`,`batting_coach` where pid=coach_id and age>1850";
    $sql2="SELECT player_name,player_id,team_details,coach_name from `bowler_details`,`bowling_coach` where coach_id=player_id and Ratings between 1850 and 1870 order by Ratings";
...
<h2 style="padding-bottom: 2rem;padding-top: 2rem;text-align: center">Top 3 Grade B Players</h2>
    <div class="table_class" style="padding-left: 2rem;padding-right:2rem">
   <table class="table table-hover table-dark">
  <thead>
    <?php
   //STEP 1:ESTABLISHMENT OF CONNECTION IS DONE OVER HERE
    ...
    //SELECT QUERIES
   // $sql="SELECT pname,team,date_of_birth,age,coach_name from `testing_val`,`batting_coach` where pid=coach_id and age>1850";
    $sql2="SELECT player_name,player_id,team_details,coach_name from `bowler_details`,`bowling_coach` where coach_id=player_id and Ratings between 1850 and 1870 order by Ratings desc limit 3";
    //we are trying to render the information on to the screen
    $result2=mysqli_query($connection,$sql2);
    //$result1=mysqli_query($connection,$sql2);
   //$num=mysqli_num_rows($result);
